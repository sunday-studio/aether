...
Reference docs describe the current project shape and durable system behavior.

## Documents

- [Project README](./project-readme.md): repo overview and local development entrypoint.
- [Architecture](./architecture.md): system overview, directory map, and backend/frontend gaps.
