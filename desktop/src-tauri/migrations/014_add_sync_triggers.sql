-- Migration: Sync infrastructure and change-tracking triggers
-- Version: XXX
-- Description: Creates sync tables and triggers to queue local changes into _sync_outbox

-- ============================================================================
-- SYNC INFRASTRUCTURE
-- ============================================================================

-- Sync outbox table - queues local changes for sync
...
-- Sync meta table - stores sync configuration
